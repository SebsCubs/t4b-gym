...
def run():
    ...
    outdoorEnvironmentSystem = model.component_dict["outdoor_environment"]

    airToAirHeatRecovery = model.component_dict["[HF04_heat_exchanger][HF04_heat_exchanger (return)][HF04_heat_exchanger (supply)]"]

    supplyFan = model.component_dict["supply_fan"]
    ...
    targetParameters = {"private": {"C_wall": {"components": spaces_list, "x0": list(C_wall_list), "lb": list(C_wall_list_lb), "ub": list(C_wall_list_ub)},
                                    ...
                                    "a": {"components": outdoorEnvironmentSystem, "x0": 0.6724895821046374, "lb": 0, "ub": 2},
                                    "b": {"components": outdoorEnvironmentSystem, "x0": 0.40665753547895367, "lb": -5, "ub": 5},
                                    "eps_75_h": {"components": airToAirHeatRecovery, "x0": 0.87, "lb": 0.60, "ub": 0.90},
                                    "eps_75_c": {"components": airToAirHeatRecovery, "x0": 0.80, "lb": 0.60, "ub": 0.90},
                                    "eps_100_h": {"components": airToAirHeatRecovery, "x0": 0.75, "lb": 0.60, "ub": 0.90},
                                    "eps_100_c": {"components": airToAirHeatRecovery, "x0": 0.80, "lb": 0.60, "ub": 0.90},
                                    "c1": {"components": supplyFan, "x0": 0.0001, "lb": 0, "ub": 1},
                                    "c2": {"components": supplyFan, "x0": 0.4999, "lb": 0, "ub": 1},
                                    "c3": {"components": supplyFan, "x0": 0.4999, "lb": 0, "ub": 1},
                                    "c4": {"components": supplyFan, "x0": 0.0001, "lb": 0, "ub": 1}
                                    },
    ...
    targetMeasuringDevices = {  model.component_dict["007A_valve_position_sensor"]: {"standardDeviation": 0.01/percentile, "scale_factor": 1},
                                ...
                                model.component_dict["BTA001"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["BTA002"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["BTA003"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["BTA004"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["BTA005"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["BTA006"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1},
                                model.component_dict["supply_fan_flow"]: {"standardDeviation": 0.1/percentile, "scale_factor": 1}
                                }
